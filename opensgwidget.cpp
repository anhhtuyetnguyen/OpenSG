...
#include "QGLWidget.h"
bool OpenSGWidget :: readData()

{
    ifstream file ("OpenSGWidget.tar.gz")
...
*/
OpenSGWidget::~OpenSGWidget() // destructor
{
}

void OpenSGWidget::stepAnimation()
{
    animstep++;    // Increase animation steps
    update();      // Trigger redraw of scene with paintGL
}

void OpenSGWidget::initializeGL() // initializations to be called once
{
...
void OpenSGWidget::paintGL() // draw everything, to be called repeatedly
{
...
void OpenSGWidget::resizeGL(int w, int h) // called when window size is changed
{
